...
const PAI_DIR = expandPath(process.env.PAI_DIR || join(homedir(), '.claude'));
...
> Auto-generated tracking file. Run \`bun ~/.claude/tools/PaiArchitecture.ts generate\` to refresh.
